...
export function checkFormValidity(
	...
	const noWarn: boolean = !activeFields.some(
		field => validationStatus[field] === 1 && !serverErrors[field],
	);
	const allDone: boolean = activeFields.every(field =>
		getDone(field, values, validationStatus, serverErrors, activeFields),
	);
