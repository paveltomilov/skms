...
export const SCHEME_POINTS: Record<string, IPoint> = {
	...
	'p.p.3.1.1': { x: 86, y: 355 },
	'p.p.3.1.2': { x: 129, y: 355 },
	'p.p.3.1.3': { x: 170, y: 355 },

	'p.p.3.2.1': { x: 208, y: 355 },
	'p.p.3.2.2': { x: 242, y: 355 },
	'p.p.3.2.3': { x: 276, y: 355 },
	...
	'p.c.3.1.1': { x: 518, y: 215 },
	'p.c.3.1.2': { x: 595, y: 215 },
	'p.c.3.1.3.2.1': { x: 776, y: 216 },
	'p.c.3.1.3.2.2': { x: 849, y: 215 },

	'p.c.3.2.1': { x: 518, y: 480 },
