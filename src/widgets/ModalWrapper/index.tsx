...
const ModalWrapper: FC<
	ModalProps & { onClose: () => void; isBlur?: boolean }
> = ({ header = 'ПКДВ-2', second = 59, onClose, isBlur = false }) => {
	useEffect(() => {
		...
		<div className={styles.overlay} onClick={onOverlayClick}>
			<div className={styles.modal} onClick={e => e.stopPropagation()}>
				...
				<p className={styles.text}>
					Введите полученный код из 6 символов, которые мы отправили
					на указанный <br /> Вами e-mail
				</p>
